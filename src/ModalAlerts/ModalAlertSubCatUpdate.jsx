...
function ModalAlertSubCatUpdate({ id, onOpen, isOpen, onClose, fetchData }) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                setSubCategoriesData(data); // API dan olingan ma'lumotlarni joylashtiring
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formData.append('name_ru', subCategoriesData.name_ru);
            formData.append('name_eng', subCategoriesData.name_eng);
            formData.append('image_name', subCategoriesData.image_name);
            ...
            if (id) {
                const response = await fetch(`https://api.cake-bumer.uz/api/subcategories/${id}`, {
                    method: 'POST',
                    body: formData,
                    headers: {
        ...
        <Box>
            <Modal isOpen={isOpen} onClose={onClose} size="lg">
                ...
                <ModalContent rounded={"sm"}>
                    <ModalHeader>Update SubCategories</ModalHeader>
                    <ModalCloseButton />
                    {isNewLoading ?
                                ...
                                <form onSubmit={handleSubmit}>
                                    <FormControl>
                                        ...
                                        <Input
                                            ...
                                            id="name_ru"
                                            name="name_ru"
                                            value={subCategoriesData.name_ru}
                                    ...
                                    <FormControl mt={"5px"}>
                                        ...
                                        <Input
                                            ...
                                            id="name_eng"
                                            name="name_eng"
                                            value={subCategoriesData.name_eng}
                                            onChange={handleInputChange}
                                            required
                                        />
                                    </FormControl>
...
export default ModalAlertSubCatUpdate;
